...
[*опций отображения*](#opcii-otobrazheniya).

Если ни один путь не подошел, то выполняется обработчик по умолчанию,
см. также [*функции приложения*](#funkcii-prilozheniya).
...
[предобработчиках](#predobrabotchiki),
...
[опции конфигурации](configuration.html).
